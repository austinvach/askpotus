      ...
      <div className="flex flex-wrap justify-center gap-4 md:gap-6">
        {PRESIDENTS.map((president) => (
          <motion.button
            ...
            className="group relative flex flex-col items-center text-left bg-white rounded-2xl overflow-hidden box-shadow-document transition-all duration-300 border-2 border-transparent hover:border-accent outline-none focus-visible:ring-4 focus-visible:ring-accent/30 w-[220px]"
          >
